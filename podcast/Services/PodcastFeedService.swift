...
//    func updateAllSubscribedPodcasts(feeds: [Podcast]) async -> [Episode] {
//        do {
...
//    }
    ...
    func fetchChannel(for url: URL) async throws -> RSSChannel {
...
//    }
    ...
    func fetchNewChapters(for chaptersUrl: String) async throws -> ChapterResponse? {
